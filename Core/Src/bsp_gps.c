...
*********************************************************************************************************
*/
void gps_pro(unsigned char *getGPSBuff , unsigned int LenGPSBuff)
{
	...
	while (1)
	{
		for(loopi = 0 ; loopi < LenGPSBuff ; loopi++)
		{
			uint8_t ucData = *(getGPSBuff + loopi);
...
void gpsGPRMC(uint8_t *_ucaBuf, uint16_t _usLen)
{
	...
	//启动消息队列msgQueue_GPS_Data
	os_Status = osMessageQueuePut(msgQueue_GPS_Data,/* 消息队列的名字 */
								  &g_tGPS, 			/* 放入消息队列的变量（消息） */
								  NULL,      		/* 放入消息的优先级 */
...
//	}
//	
//	else if (memcmp(_ucaBuf, "GNGGA,", 6) == 0)
//	{
//		//gpsGPGLL(_ucaBuf, _usLen);
//		printf("gps is GNGGA \r\n");
//	}		
...
//		printf("gps is GNGLL \r\n");
//	}
//	else if (memcmp(_ucaBuf, "GNGSA,", 6) == 0)
//	{//1 1
//		//gpsGPGLL(_ucaBuf, _usLen);
//		printf("gps is GNGSA \r\n");
//	}
//	else if (memcmp(_ucaBuf, "GNGSV,", 6) == 0)
//	{//1 1
//		//gpsGPGLL(_ucaBuf, _usLen);
//		printf("gps is GNGSV \r\n");
//	}
...
//	}	
	...
	else if(memcmp(_ucaBuf, "GPTXT,", 6) == 0)
	{//这个是原厂信息打印
		//printf("gps is GPTXT \r\n");
	}
	else
	{
		//printf("gps is outher \r\n");
	}
}
